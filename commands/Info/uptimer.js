...
module.exports = {
  ...
  run: async (client, message, args ) => {
      ...
      .setTitle('🌟 How to Use Uptimer!n')
      .addField("⌨️ **Run the command**",
        "Our next step is to run the command. The syntax of this command is `*add <repl_url>.` If done correcty the bot should give embed saying: \n ```Added Succesfully```"
      )
      ...
      .setTitle('🌟 How to Use Uptimer!n')
      .addField("ㅤ🖥️ **Other Commands**","Now that we have added your project, you can use other command such as `projects` `remove` `stats` and `total`. Below Is an image of the remove command")
