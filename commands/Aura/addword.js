...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        let added = new Discord.MessageEmbed().setColor(colors.uptime).setAuthor(`${message.author.username}`, `${message.author.avatarURL({dynamic:true})}`).setDescription(`**${word}** Has Been Added ✅`);
